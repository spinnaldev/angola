...
class FCMService {
  ...
  final ApiService _apiService = ApiService(baseUrl: dotenv.env['API_BASE_URL'] ?? 'http://localhost:8004/api', apiKey: 'your_api_key_here',);
  ...
  Future<void> _checkInitialMessage() async {
    ...
    if (initialMessage != null) {
      print('📨 App ouverte depuis notification: ${initialMessage.notification?.title}');
  ...
  Future<void> _showLocalNotification(RemoteMessage message) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      'teyago_high_importance',
      'Teyago Notifications',
      channelDescription: 'Notifications importantes de Teyago Services',
    ...
    await _localNotifications.show(
      message.hashCode,
      message.notification?.title ?? 'Teyago Services',
