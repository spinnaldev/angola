...
//   ClientProject? _currentProject; // Projet avec données fraîches
//   bool _hasUserOffered = false; // État calculé dynamiquement
...
//     // Incrémenter les vues après un délai
//     Future.delayed(const Duration(milliseconds: 500), () {
//       _incrementView();
//     });
//   }
...
//       // Charger les données fraîches du projet depuis l'API
//       final projectData = await apiService.getProjectDetails(widget.project.id);
      
//       if (mounted && projectData != null) {
//         setState(() {
//           // Mettre à jour avec les données fraîches
//           _currentProject = ClientProject.fromJson(projectData);
//           _isLoadingProject = false;
//         });
//       }
//     } catch (e) {
//       print('Erreur lors du rechargement du projet: $e');
//       if (mounted) {
//         setState(() {
//           _isLoadingProject = false;
//           // Garder le projet original si l'API échoue
//           _currentProject = widget.project;
//         });
//       }
//     }
...
//       if (mounted) {
//         final userHasOffered = offers.any((offer) => 
//           offer['provider']?['id'] == _currentUserId ||
//           offer['provider'] == _currentUserId
//         );

//         setState(() {
//           _offers = offers;
//           _hasUserOffered = userHasOffered; // Mise à jour dynamique
//           _isLoadingOffers = false;
//         });
//       }
//     } catch (e) {
...
//   bool _hasUserOfferedMethod() {
//     // Utiliser l'état calculé dynamiquement plutôt que les données du projet
//     return _hasUserOffered;
//   }
//   // Fonction pour soumettre l'offre - Version corrigée
//   Future<void> _submitOffer(StateSetter setBottomSheetState) async {
//     final l10n = AppLocalizations.of(context)!;
...
//       return l10n.monthsAgo?.call(months) ?? 'Il y a $months mois';
//     } else if (difference.inDays > 0) {
//       return l10n.daysAgo?.call(difference.inDays) ?? 'Il y a ${difference.inDays} jours';
//     } else if (difference.inHours > 0) {
//       return l10n.hoursAgo?.call(difference.inHours) ?? 'Il y a ${difference.inHours} heures';
//     } else {
...
//   Widget build(BuildContext context) {
//     final l10n = AppLocalizations.of(context)!;
//     final project = _currentProject ?? widget.project; // Utiliser les données fraîches
...
//                 Tab(text: '${l10n.offers} (${_offers.length})'), // Utiliser le nombre d'offres chargées
//               ],
//             ),
//           ),
...
//         ],
//       ),
//       // Afficher le bouton seulement si l'utilisateur n'a pas encore fait d'offre
//       bottomNavigationBar: _hasUserOfferedMethod() ? null : _buildMakeOfferButton(),
//     );
//   }
//   Widget _buildDescriptionTab(ClientProject project) {
//     final l10n = AppLocalizations.of(context)!;
...
//           // Informations du projet avec données fraîches
//           Container(
//             padding: const EdgeInsets.all(16),
//             decoration: BoxDecoration(
//               color: Colors.grey[50],
...
//                   Icons.visibility,
//                   l10n.views,
//                   '${project.viewsCount} ${l10n.views.toLowerCase()}',
//                 ),

//                 _buildInfoRow(
//                   Icons.local_offer,
//                   l10n.offers,
//                   '${_offers.length} ${l10n.offers.toLowerCase()}', // Nombre d'offres chargées
//                 ),
...
//           if (project.attachments?.isNotEmpty == true) ...[
//             const SizedBox(height: 24),
//             Text(
//               l10n.attachments,
//               style: const TextStyle(
...
//   Future<void> _onOfferSubmitted() async {
//     // Recharger les offres et mettre à jour l'état
//     await _loadOffers();
    
//     // Optionnellement, rafraîchir aussi les données du projet
//     await _refreshProjectData();
//   }
//   // ... [Toutes vos autres méthodes _buildAppBar, _buildProjectHeader, etc. restent identiques]
//   // Je vais les inclure pour la complétude:
...
//                 ),
//                 child: Text(
//                   project.categoryName, // Utiliser project au lieu de widget.project
//                   style: const TextStyle(
//                     color: Color(0xFF6366F1),
//                     fontSize: 14,
//                     fontWeight: FontWeight.w600,
...
//           const SizedBox(height: 16),
//           Text(
//             project.title, // Utiliser project
//             style: const TextStyle(
//               fontSize: 24,
//               fontWeight: FontWeight.bold,
//               color: Colors.black87,
...
//               const SizedBox(width: 4),
//               Text(
//                 project.clientName, // Utiliser project
//                 style: TextStyle(
//                   color: Colors.grey[600],
//                   fontSize: 14,
//                 ),
...
//               const SizedBox(width: 4),
//               Text(
//                 _getTimeAgo(project.createdAt), // Utiliser project
//                 style: TextStyle(
//                   color: Colors.grey[600],
//                   fontSize: 14,
//                 ),
...
//           const SizedBox(height: 12),
//           Text(
//             project.description, // Utiliser project
//             style: const TextStyle(
//               fontSize: 16,
//               height: 1.5,
//               color: Colors.black87,
